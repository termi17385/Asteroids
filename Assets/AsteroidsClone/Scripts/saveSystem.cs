...
public class SaveSystem : MonoBehaviour
{
...
#if UNITY_EDITOR	
	path = Application.persistentDataPath + "/EditorDataHighscore.dat";	
#endif
	...
	/// <summary>
	/// Used to create a default file if one doesnt exist
	/// </summary>
	...
	public HighscoreData LoadData()
	{
		...
		try { return (HighscoreData) formatter.Deserialize(fs); }
		catch(SerializationException e)
		{
